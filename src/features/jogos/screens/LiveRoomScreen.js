...
const LiveRoomScreen = () => {
  ...
  const carregarStatusReserva = useCallback(async () => {
    try {
      ...
      // Não mostramos alerta aqui para não interromper o carregamento da tela
    }
  }, [id_jogo]);
  ...
  const renderPlayer = ({ item, index }) => {
    ...
    // Gerar uma cor de fundo baseada no nome do jogador para consistência
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        {/* Card laranja com informações principais - NÃO FIXO */}
              ...
              <View style={styles.actionsRow}>
                ...
                >
                  <View style={[
                    ...
                    { backgroundColor: linkSala ? '#10B981' : '#9CA3AF' }
                  ]}>
        ...
        {/* Status da Reserva (se tiver reserva) */}
        {reservationStatus && (
          <View style={[
            styles.reservationStatusCard,
            { 
              backgroundColor: 
                reservationStatus === 'aprovada' ? '#E6F7EF' : 
                reservationStatus === 'rejeitada' ? '#FEEBEB' : '#FFF9E6',
              borderLeftColor:
                reservationStatus === 'aprovada' ? '#34D399' : 
                reservationStatus === 'rejeitada' ? '#EF4444' : '#F59E0B',
            }
          ]}>
            <View style={styles.reservationStatusHeader}>
              <MaterialCommunityIcons 
                name={
                  reservationStatus === 'aprovada' ? 'check-circle' : 
                  reservationStatus === 'rejeitada' ? 'close-circle' : 'clock-outline'
                } 
                size={22} 
                color={
                  reservationStatus === 'aprovada' ? '#34D399' : 
              ...
              <Text style={[
                ...
                {reservationStatus === 'aprovada' ? 'Reserva Confirmada' : 
                 reservationStatus === 'rejeitada' ? 'Reserva Rejeitada' : 
        ...
        <View style={styles.playersSection}>
          <View style={styles.tabsContainer}>
            ...
            >
              <Text style={[
                styles.tabText, 
                activeTab === 'confirmados' && styles.activeTabText
              ]}>
            ...
            >
              <Text style={[
                styles.tabText, 
                activeTab === 'espera' && styles.activeTabText
              ]}>
        ...
        {/* Espaço adicional no final para scrollar adequadamente */}
...
const styles = StyleSheet.create({
  ...
  playersListContainer: {
    padding: 16,
    minHeight: 200, // Garantir espaço mesmo sem jogadores
  },
  playerCard: {
    backgroundColor: '#FFF',
    borderRadius: 8,
